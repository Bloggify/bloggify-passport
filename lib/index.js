 ...
 */
module.exports = function (conf, Bloggify) {
    ...
    conf.auth_options = (0, _assign2.default)({
    ...
    passport.use(new Strategy(conf.strategy_options, function () {
    ...
    Bloggify.server.before(conf.login_url, "post", function (ctx, cb) {
        ...
        passport.authenticate(conf.strategy, conf.auth_options, function (err, user, info) {
            if (err) {
                return done(err);
            }
    ...
    Bloggify.server.before("*", "all", function (ctx) {
